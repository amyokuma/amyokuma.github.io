  ...
  return (
    <div className="bg-transparent flex mb-12 lg:gap-32 xl:gap-72">
        ...
        <div className="bg-transparent relative">
          <video src={videoSrc} className="absolute h-auto w-[330px] top-[4rem] left-[20px] lg:w-[432px] xl:w-[630px] 2xl:w-[800px] rounded-xl lg:top-[10rem] 2xl:top-[15rem] xl:left-[40px]" autoPlay muted loop />
